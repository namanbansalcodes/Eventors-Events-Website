...
$mailthis=$mailthis.'Social: '.$_POST['social'].PHP_EOL;
$mailthis=$mailthis.'What is your story? Tell us about your family, hobbies ANYTHING!'.PHP_EOL.$_POST['desc1'].PHP_EOL;
